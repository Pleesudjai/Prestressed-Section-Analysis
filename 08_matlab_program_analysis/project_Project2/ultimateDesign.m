...
design_code = 'CEE530';   % <--- CHANGE HERE: 'CEE530'  or  'ACI-318-19'
...
b  = 120;        % full flange width (in)
hf = 2;          % flange thickness (in)  [y = 26 to 28]
bw = 2 * 4.75;   % total web (stem) width (in) = 9.50 in
...
%% ======================================================================
rpt_file = fullfile(output_dir, 'Ultimate_Report.txt');
